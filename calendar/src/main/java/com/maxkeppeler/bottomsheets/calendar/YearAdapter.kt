...
internal class YearAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): YearItem =
        YearItem(
            BottomSheetsCalendarYearItemBinding.inflate(
    ...
    private fun BottomSheetsCalendarYearItemBinding.handleState(yearAtIndex: Year) = when {
    ...
    inner class YearItem(val binding: BottomSheetsCalendarYearItemBinding) :
