...
class CalendarSheet : BottomSheet() {
    ...
    private lateinit var binding: BottomSheetsCalendarBinding
    ...
    private fun BottomSheetsCalendarBinding.setupSwitchViews() {
    ...
    private fun BottomSheetsCalendarBinding.setupCalendarView() {
